...
def configure_rest_concurrency(max_concurrent: int) -> None:
    ...
    from engine.market._proxy_session import set_per_proxy_concurrency  # noqa: PLC0415
...
class BinanceFuturesMarketData:
    ...
    async def fetch_open_interest_series(
        ...
        return await self._binance_client.fetch_open_interest_series(
    ...
    async def fetch_global_ls_series(
        ...
        return await self._binance_client.fetch_global_ls_series(
            symbol, period=period, limit=limit
        )
