...
```bash
python scripts/live_supervised_session.py --hours 6 --minutes 360 --snapshot-interval 60 --takeover
```

Await until exit. Reap zombies: `bash scripts/reap_agent_terminals.sh`
