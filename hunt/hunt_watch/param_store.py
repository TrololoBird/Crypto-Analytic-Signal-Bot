...
from hunt_watch.market_regime import HuntCalibratedParams, active_params
from hunt_watch.paths import ADAPTIVE_THRESHOLDS, EWMA_THRESHOLDS, HUNT_CALIBRATION
...
def universal_section(section: str) -> dict[str, Any]:
    ...
    return _deep_merge(base if isinstance(base, dict) else {}, overlay)
