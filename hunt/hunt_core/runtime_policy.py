...
def resolve_setup_entry_tf(setup_id: str, *, default: str = "15m") -> str:
    ...
    from hunt_core.domain.strategy_catalog import CATALOG_BY_ID
...
def resolve_setup_order_type(setup_id: str, *, default: str = "limit") -> str:
    from hunt_core.domain.strategy_catalog import resolve_setup_order_type as _catalog_order

    return _catalog_order(setup_id, default=default)


def resolve_setup_ttl_minutes(setup_id: str, *, default: int = 120) -> int:
    from hunt_core.domain.strategy_catalog import resolve_setup_ttl_minutes as _catalog_ttl
