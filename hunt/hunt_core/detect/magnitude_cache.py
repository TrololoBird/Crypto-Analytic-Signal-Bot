...
from hunt_core.detect.factors import compute_factors
from hunt_core.detect.fusion import bar_vol_adjusted_magnitude
from hunt_core.detect.windows import FeatureWindow, build_window
