...
from hunt_core._dev.expansion_lab.blocks import score_base_blocks
from hunt_core._dev.expansion_lab.blocks import state_persistence as persistence_block
from hunt_core._dev.expansion_lab.blocks import trigger_proximity as trigger_block
from hunt_core._dev.expansion_lab.config import ExpansionConfig, load_expansion_config
from hunt_core._dev.expansion_lab.deltas import compute_deltas
from hunt_core._dev.expansion_lab.execution import build_execution
from hunt_core._dev.expansion_lab.forecast import build_forecast
from hunt_core._dev.expansion_lab.history import ExpansionHistory, global_history
from hunt_core._dev.expansion_lab.probability_model import ExpansionProbabilityModel
from hunt_core._dev.expansion_lab.quality import (
    expansion_quality,
    fake_breakout_risk,
    readiness,
    risk_label,
...
from hunt_core._dev.expansion_lab.stages import classify_lifecycle_stage, derive_state
...
def _scores_from(blocks: dict[str, BlockResult]):
    from hunt_core._dev.expansion_lab.types import BlockScores
