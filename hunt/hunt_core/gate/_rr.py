...
from hunt_core.gate._types import BOUNCE_MIN_RISK_REWARD, GateResult
...
def setup_fuel(setup: dict[str, Any], direction: str) -> float:
    ...
    from hunt_core.gate._ev import setup_p_win
...
def order_flow_demotes_triggered(row: dict[str, Any], *, direction: str) -> bool:
    from hunt_core.analysis.deep_signal import synthesize_order_flow
