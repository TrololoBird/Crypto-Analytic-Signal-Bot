...
def _gate_stale(
    *,
    ...
    from hunt_core.gate._freshness import delivery_hard_block
...
def _gate_wash(
    *,
    ...
    from hunt_core.gate._wash import wash_block_reason
...
def _gate_kinematic(
    *,
    ...
    from hunt_core.gate._wash import kinematic_block_reason
...
def run_gate_pipeline(
    *,
    ...
    from hunt_core.gate._report import evaluate_alert_gate
