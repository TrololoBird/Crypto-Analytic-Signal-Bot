...
def _tf_closed_block(tf: dict[str, Any] | None, interval: str) -> dict[str, Any]:
    from hunt_core.toolkit.kline_flow import tf_closed_block as _block
...
def kline_bar_flow(
    ...
    from hunt_core.toolkit.kline_flow import kline_bar_flow as _flow
...
def resolve_flow_cvd_px(
    ...
    *,
    ...
    from hunt_core.toolkit.kline_flow import resolve_flow_cvd_px as _resolve
