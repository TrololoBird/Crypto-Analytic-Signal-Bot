...
def _detect_structure(
    ...
    *,
    ...
    # Deeper levels: swing pivots below the nearest support / above nearest resistance.
    deeper_supports = [p for p in _all_swing_lows if p < (support or 0)]
    deeper_resistances = [p for p in _all_swing_highs if p > (resistance or float("inf"))]
