...
from hunt_core.paths import DEEP_TICKS_JSONL, VERDICT_V2_CALIBRATION_JSON, VERDICT_V2_GATE_OVERRIDES_JSON

CALIBRATION_JSON = VERDICT_V2_CALIBRATION_JSON
GATE_OVERRIDES_JSON = VERDICT_V2_GATE_OVERRIDES_JSON
...
def write_gate_overrides(suggestions: dict[str, Any]) -> Path:
    payload = {
        "updated_at": datetime.now(UTC).isoformat(),
    ...
    GATE_OVERRIDES_JSON.write_text(json.dumps(payload, indent=2), encoding="utf-8")
    return GATE_OVERRIDES_JSON
