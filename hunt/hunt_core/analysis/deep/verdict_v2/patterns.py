...
from hunt_core.analysis.deep.verdict_v2.market_driver import filter_patterns_by_driver
...
def generate_patterns(
    ...
    if row.get("symbol"):
        from hunt_core.analysis.deep.verdict_v2.audit import append_pattern_audit
