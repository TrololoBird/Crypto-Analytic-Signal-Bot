...
class FiveModuleResult:
    ...
    def to_summary_dict(self) -> dict[str, Any]:
        return {
            ...
            "modules": {
                "macro": {"status": self.macro.status, "reason": self.macro.reason},
                "trend": {"status": self.trend.status, "reason": self.trend.reason},
                "structure": {"status": self.structure.status, "reason": self.structure.reason},
                "positioning": {"status": self.positioning.status, "reason": self.positioning.reason},
                "risk": {"status": self.risk.status, "reason": self.risk.reason},
            },
        }
