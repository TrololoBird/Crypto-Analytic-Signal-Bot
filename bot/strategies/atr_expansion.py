...
class ATRExpansionSetup(RoadmapSetup):
    ...
    def detect(self, prepared: PreparedSymbol, settings: BotSettings) -> Signal | None:
        ...
        candidate = self._current_expansion_candidate(work, params, timeframe="15m")
    ...
    def _current_expansion_candidate(
        ...
        *,
        ...
        prev_close = _as_float(work.item(-2, "close"))
        ...
        if body_atr < float(params["min_body_atr"]):
            return None
        return {
