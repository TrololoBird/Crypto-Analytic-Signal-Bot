...
class VWAPTrendSetup(BaseSetup):
    ...
    def detect(self, prepared: PreparedSymbol, settings: BotSettings) -> Signal | None:
        ...
        prev_close = as_float(work_15m.item(-2, "close"))
        vwap = as_float(work_15m.item(-1, "vwap"))
        prev_vwap = as_float(work_15m.item(-2, "vwap"))
        ...
        tolerance = params["vwap_reclaim_tolerance_pct"]
