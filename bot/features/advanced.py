...
`bot.features.shared.supertrend_series`.
"""
...
from .structure import hull_moving_average, ichimoku_lines

__all__ = ["add_advanced_indicators", "supertrend"]
MODULE_STATUS = "internal_only"
CANONICAL_FEATURE_API = "bot.features._prepare_frame"
CANONICAL_SUPERTREND_API = "bot.features.shared.supertrend_series"
