...
def create_outcome_from_tracked(
    ...
    pnl_pct = 0.0
    pnl_r_multiple = 0.0
    if entry_price and exit_price and not is_monitoring_close:
    ...
    elif is_active_expiry:
        outcome_result = "expired_active"
    elif is_unactivated_close:
        outcome_result = "unactivated_close"
    elif outcome_result == "smart_exit":
        outcome_result = "risk_monitor_exit"
